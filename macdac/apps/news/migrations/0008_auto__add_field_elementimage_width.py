...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElementImage.width'
        db.add_column('news_elementimage', 'width',
                      self.gf('django.db.models.fields.CharField')(default='300', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ElementImage.width'
        db.delete_column('news_elementimage', 'width')
    ...
    models = {
        'news.element': {
            ...
            'date_start_publication': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'full': ('django.db.models.fields.TextField', [], {'db_index': 'True'}),
            'full_prepared': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'news.elementimage': {
            ...
            'element': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'to': "orm['news.Element']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'width': ('django.db.models.fields.CharField', [], {'default': "'300'", 'max_length': '3'})
        },
        'news.source': {
