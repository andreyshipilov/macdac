...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Element.full_prepared'
        db.add_column('news_element', 'full_prepared',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Element.full_prepared'
        db.delete_column('news_element', 'full_prepared')
