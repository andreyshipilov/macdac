...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Element.date_start_publication'
        db.add_column('news_element', 'date_start_publication',
                      self.gf('django.db.models.fields.DateTimeField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Element.date_start_publication'
        db.delete_column('news_element', 'date_start_publication')
